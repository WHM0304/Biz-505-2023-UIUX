// js 코드를 html 어디에 있던지 정상 실행 되도록 하기위한 시작코드
document.addEventListener("DOMContentLoaded", () => {
  ...
  // const txt_username = input_username.input_username.value;
  // const txt_password = input_password.input_password.value;
  btn_login?.addEventListener("click", () => {
    ...
    // document.querySelector("form").submit();   // 아래와 같은 코드
